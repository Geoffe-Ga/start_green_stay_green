...
class TestTokenUsage:
    ...
    def test_token_usage_total_tokens_exact_calculation(self) -> None:
        """Test TokenUsage calculates exact total_tokens value (kills mutants)."""
        usage = TokenUsage(input_tokens=25, output_tokens=35)

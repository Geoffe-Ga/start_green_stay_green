#!/usr/bin/env bash
# scripts/complexity.sh - Thin POSIX delegate to the cross-platform gate runner (#382).
#
...
#
#   python -m start_green_stay_green.gates complexity [args...]
#
# Usage: ./scripts/complexity.sh [args...]   (see --help for options)
...
python -m start_green_stay_green.gates complexity "$@"

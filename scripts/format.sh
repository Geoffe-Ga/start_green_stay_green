#!/usr/bin/env bash
# scripts/format.sh - Thin POSIX delegate to the cross-platform gate runner (#382).
#
...
#
#   python -m start_green_stay_green.gates format [args...]
#
# Usage: ./scripts/format.sh [args...]   (see --help for options)
...
python -m start_green_stay_green.gates format "$@"

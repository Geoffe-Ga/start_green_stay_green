#!/usr/bin/env bash
# scripts/mutation.sh - Thin POSIX delegate to the cross-platform gate runner (#382).
#
...
#
#   python -m start_green_stay_green.gates mutation [args...]
#
# Usage: ./scripts/mutation.sh [args...]   (see --help for options)
...
python -m start_green_stay_green.gates mutation "$@"

#!/usr/bin/env bash
# scripts/typecheck.sh - Thin POSIX delegate to the cross-platform gate runner (#382).
#
...
#
#   python -m start_green_stay_green.gates typecheck [args...]
#
# Usage: ./scripts/typecheck.sh [args...]   (see --help for options)
...
python -m start_green_stay_green.gates typecheck "$@"

#!/usr/bin/env bash
# scripts/test.sh - Thin POSIX delegate to the cross-platform gate runner (#382).
#
...
#
#   python -m start_green_stay_green.gates test [args...]
#
# Usage: ./scripts/test.sh [args...]   (see --help for options)
...
python -m start_green_stay_green.gates test "$@"

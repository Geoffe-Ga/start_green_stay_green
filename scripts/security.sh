#!/usr/bin/env bash
# scripts/security.sh - Thin POSIX delegate to the cross-platform gate runner (#382).
#
...
#
#   python -m start_green_stay_green.gates security [args...]
#
# Usage: ./scripts/security.sh [args...]   (see --help for options)
...
python -m start_green_stay_green.gates security "$@"

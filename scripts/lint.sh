#!/usr/bin/env bash
# scripts/lint.sh - Thin POSIX delegate to the cross-platform gate runner (#382).
#
...
#
#   python -m start_green_stay_green.gates lint [args...]
#
# Usage: ./scripts/lint.sh [args...]   (see --help for options)
...
python -m start_green_stay_green.gates lint "$@"

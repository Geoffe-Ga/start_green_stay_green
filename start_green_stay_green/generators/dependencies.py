...
"""
    ...
    def _typescript_package_json(self) -> str:
        ...
        The StrykerJS packages back the generated scripts/mutation.sh
        gate; shipping them in devDependencies makes `npm ci` enough to
        run it, mirroring mutmut in the Python requirements-dev.txt

...
<body>
    <div class="container">
        ...
        <div class="metrics-grid">
            ...
            <div class="metric-card">
                ...
                <div class="metric-value" id="maintainability-value">--</div>
                <div class="metric-threshold">
                    Threshold: ≥{self.config.maintainability_threshold}
                </div>
                <div class="metric-status status-pass" id="maintainability-status">
                    PASSING
                </div>
            </div>

            <div class="metric-card">
                <div class="metric-name">Lint Violations</div>
                <div class="metric-value" id="lint-value">--</div>
                <div class="metric-threshold">Threshold: 0</div>
                <div class="metric-status status-pass" id="lint-status">
                    PASSING
                </div>
            </div>
            ...
            <div class="metric-card">
                ...
                <div class="metric-threshold">Threshold: 0</div>
                <div class="metric-status status-pass" id="typecheck-status">
                    PASSING
                </div>
            </div>

            <div class="metric-card">
                <div class="metric-name">Test Count</div>
                <div class="metric-value" id="tests-value">--</div>
                <div class="metric-threshold">Threshold: All passing</div>
                <div class="metric-status status-pass" id="tests-status">
                    PASSING
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function updateDashboard(data) {{
            ...
            if (metrics.maintainability_avg !== undefined) {{
            ...
            if (metrics.lint_violations !== undefined) {{
                if (metrics.lint_violations === null) {{
                    ...
                    updateStatus('lint',
                        metrics.lint_violations === 0 ? 'PASSING' : 'FAILING',
                        metrics.lint_violations === 0);
                }}
            }}
            ...
            if (metrics.type_errors !== undefined) {{
                if (metrics.type_errors === null) {{
                    ...
                    updateStatus('typecheck',
                        metrics.type_errors === 0 ? 'PASSING' : 'FAILING',
            ...
            if (metrics.tests_total !== undefined) {{
                if (metrics.tests_total === null) {{
                    ...
                    elem.textContent = metrics.tests_total +
                        (failed > 0 ? ' (' + failed + ' failed)' : '');
                    updateStatus('tests',
                        failed === 0 ? 'PASSING' : 'FAILING',
                        failed === 0);
                }}
            }}
        }}
